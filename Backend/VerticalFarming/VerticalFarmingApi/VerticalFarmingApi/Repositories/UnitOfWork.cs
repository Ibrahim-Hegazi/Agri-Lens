...
namespace VerticalFarmingApi.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IRepository<AIAnalysisController> _aiAnalysis;
        ...
        public IRepository<AIAnalysisController> AiAnalysis => _aiAnalysis ??= new Repository<AIAnalysisController>(_context);
